...
struct common_commands {
    ...
    static auto ping(std::size_t index, const Arguments& args) -> ResponsePtr;

    // keys pattern
    // return all keys matching pattern
    static auto keys(std::size_t index, const Arguments& args) -> ResponsePtr;
    ...
    static auto mget(std::size_t index, const Arguments& args) -> ResponsePtr;

    // del key [key ...]
    // Removes the specified keys. A key is ignored if it does not exist.
    // The command returns the number of keys that were removed.
    static auto del(std::size_t index, const Arguments& args) -> ResponsePtr;
    ...
    static auto flushdb(std::size_t index, const Arguments& args) -> ResponsePtr;

    // dbsize
    // return the number of keys in the currently-selected database.
    static auto dbsize(std::size_t index, const Arguments& args) -> ResponsePtr;

    // expire key seconds
    // Set a timeout on key. After the timeout has expired, the key will automatically be deleted.
    // If the key does not exist, it returns 0. Otherwise, it returns 1.
    static auto expire(std::size_t index, const Arguments& args) -> ResponsePtr;
    ...
    static auto ttl(std::size_t index, const Arguments& args) -> ResponsePtr;
    ...
    static auto persist(std::size_t index, const Arguments& args) -> ResponsePtr;
    ...
    static auto exists(std::size_t index, const Arguments& args) -> ResponsePtr;
};
