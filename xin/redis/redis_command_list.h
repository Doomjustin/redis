...
struct list_commands {
    ...
    static auto push(Database& db, const Arguments& args) -> ResponsePtr;
    ...
    static auto pop(Database& db, const Arguments& args) -> ResponsePtr;
    ...
    static auto range(Database& db, const Arguments& args) -> ResponsePtr;
};
